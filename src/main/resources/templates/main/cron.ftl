...
<head>
  <title>Be Cron - 在线Cron表达式生成器</title>
    ...
    <link href="/static/plugin/cron/css/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="/static/plugin/cron/css/icon.css" rel="stylesheet" type="text/css" />
    <link href="/static/plugin/cron/icon.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .line
        {
            height: 25px;
...
<body>
    ...
    <script src="/static/plugin/cron/jquery-1.6.2.min.js" type="text/javascript"></script>
    <script src="/static/plugin/cron/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="/static/plugin/cron/cron.js" type="text/javascript"></script>
</body>
</html>
